...
typedef PickerItemBuilder = Widget Function(IconData icon, bool isCurrentIcon, VoidCallback changeIcon);
...
class IconPicker extends StatefulWidget {
  ...
  const IconPicker({super.key,
    ...
    this.availableIcons = defaultIcons,
  ...
  static Widget defaultItemBuilder(IconData icon, bool isCurrentIcon, VoidCallback changeIcon) {
    return Container(
